...
@Repository
public interface Meal_IngredientRepository extends JpaRepository<Meal_Ingredient, Integer> {

   List<Meal_Ingredient> findBySodium(Integer sodium);
   Meal_Ingredient findByIngredient(String ingredient);
   List<Meal_Ingredient> findAll();
   ...
   @Query("SELECT new com.example.apka_prozdrowotna.model.dto.MealIngredientDTO(" +
           ...
           "FROM Meal_Ingredient mi JOIN Snacks s ON mi.meal_ingredient_id = s.meal_ingredient_id " +
   ...
   @Query("SELECT new com.example.apka_prozdrowotna.model.dto.MealIngredientDTO(" +
           ...
           "FROM Meal_Ingredient mi JOIN Breakfast b ON mi.meal_ingredient_id = b.meal_ingredient_id " +
   ...
   @Query("SELECT new com.example.apka_prozdrowotna.model.dto.MealIngredientDTO(" +
           ...
           "FROM Meal_Ingredient mi JOIN Lunch l ON mi.meal_ingredient_id = l.meal_ingredient_id " +
